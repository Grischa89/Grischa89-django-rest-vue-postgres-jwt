...
def checkout(request):
    ...
    print("checkout request.user:", request.user)
...
class OrdersList(APIView):
    ...
    def get(self, request, format=None):
        print("OrdersList request:", request)
        print("OrdersList request.data:", request.data)
        print("OrdersList request.user:", request.user)
